import {
  createMutation, createQuery, type MutationOptions, type QueryOptions,
...
export type CreateCatMutation = { __typename?: 'Mutation', create_cat_item?: { __typename?: 'cat', id: string } | null };
...
export const useCreateCatMutation = <
  ...
  TContext = unknown
>(options?: MutationOptions<CreateCatMutation, TError, CreateCatMutationVariables, TContext>) => createMutation<CreateCatMutation, TError, CreateCatMutationVariables, TContext>(
  ['createCat'],
...
>(
  ...
  options?: QueryOptions<CatByIdQuery, TError, TData>,
) => createQuery<CatByIdQuery, TError, TData>(
  ['catById', variables],
...
>(
  ...
  options?: QueryOptions<FindAllCatsQuery, TError, TData>,
) => createQuery<FindAllCatsQuery, TError, TData>(
