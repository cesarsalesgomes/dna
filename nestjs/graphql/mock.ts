...
import {
  ...
  DateFilterOperators,
  DatetimeFunctionFilterOperators,
  DatetimeFunctions,
...
export const aCatFilter = (overrides?: Partial<CatFilter>): CatFilter => {
  return {
    ...
    date_created_func:
      overrides && overrides.hasOwnProperty('date_created_func') ? overrides.date_created_func! : aDatetimeFunctionFilterOperators(),
    ...
    date_updated_func:
      overrides && overrides.hasOwnProperty('date_updated_func') ? overrides.date_updated_func! : aDatetimeFunctionFilterOperators(),
...
export const aCreateCatInput = (overrides?: Partial<CreateCatInput>): CreateCatInput => {
  return {
    ...
    date_created_func:
      overrides && overrides.hasOwnProperty('date_created_func') ? overrides.date_created_func! : aDatetimeFunctionsInput(),
    ...
    date_updated_func:
      overrides && overrides.hasOwnProperty('date_updated_func') ? overrides.date_updated_func! : aDatetimeFunctionsInput(),
...
export const aDirectusFilesFilter = (overrides?: Partial<DirectusFilesFilter>): DirectusFilesFilter => {
  return {
    ...
    uploaded_on_func:
      overrides && overrides.hasOwnProperty('uploaded_on_func') ? overrides.uploaded_on_func! : aDatetimeFunctionFilterOperators(),
    ...
    modified_on_func:
      overrides && overrides.hasOwnProperty('modified_on_func') ? overrides.modified_on_func! : aDatetimeFunctionFilterOperators(),
...
export const aDirectusUsersFilter = (overrides?: Partial<DirectusUsersFilter>): DirectusUsersFilter => {
  return {
    ...
    last_access_func:
      overrides && overrides.hasOwnProperty('last_access_func') ? overrides.last_access_func! : aDatetimeFunctionFilterOperators(),
    ...
    external_identifier:
      overrides && overrides.hasOwnProperty('external_identifier') ? overrides.external_identifier! : aStringFilterOperators(),
    auth_data: overrides && overrides.hasOwnProperty('auth_data') ? overrides.auth_data! : aStringFilterOperators(),
    email_notifications:
      overrides && overrides.hasOwnProperty('email_notifications') ? overrides.email_notifications! : aBooleanFilterOperators(),
