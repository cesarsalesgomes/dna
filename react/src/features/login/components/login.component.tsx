          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="prose bg-gray-50 dark:bg-gray-900 px-2 dark:prose-invert ">Or continue with</span>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              <div>
                ...
                >
                  ...
                  <svg className="h-5 w-5" aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512">
                    <path
