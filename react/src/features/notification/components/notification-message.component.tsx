...
import { SetNotificationMessageAndType } from '../types';

import NotificationIcon from './notification-icon.component';
import NotificationLabel from './notification-label.component';

export default function NotificationMessage({ message, setMessageAndType }: { message: string, setMessageAndType: SetNotificationMessageAndType }) {
  return (
    <div
      aria-live="assertive"
