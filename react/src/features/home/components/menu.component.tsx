            ...
            <div className="relative flex items-center justify-between" style={{ height: MENU_NAVBAR_HEIGHT }}>
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <HeadlessUiMenu as="div" className="ml-3 relative">
                  <div>
                    <HeadlessUiMenu.Button className="bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
