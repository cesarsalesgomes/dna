...
import { useGetUserAvatarUrl } from '../hooks';
      ...
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-between" style={{ height: MENU_NAVBAR_HEIGHT }}>
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                {/* Profile dropdown */}
                <HeadlessUiMenu as="div" className="relative ml-3">
                  <div>
                    <HeadlessUiMenu.Button className="flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
